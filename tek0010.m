...
%
%    filename: /Users/danieldacosta/Documents/TCC_Matlab/190801/tek0010.csv
%
...
% Import the data
tbl = readtable("/Users/danieldacosta/Documents/TCC_Matlab/190801/tek0010.csv", opts);
...
timeVector = TIME(end/2:end);
PIEZO_trunc = PIEZO(end/2:end);
